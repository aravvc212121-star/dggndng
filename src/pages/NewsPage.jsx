...
export default function NewsPage() {
  ...
  return (
    <div className="h-full w-full flex flex-col relative overflow-hidden bg-black" id="news-page">
      ...
      >
        {articles.map((article, index) => (
          <article
            key={article.id}
            className="story-slide w-full max-w-full shrink-0 basis-full flex-none h-full snap-start flex items-center justify-center bg-black box-border"
          >
